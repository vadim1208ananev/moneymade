...
export const getDataMoneybarWidget = (data) => {
...
export const getPlatformsBySource=(symbol)=>{
    return fetch(`https://us-central1-benchmark-media.cloudfunctions.net/getV2PremiumWithCustomOffers?source=${symbol}`)
