...
export const getDataCryptopageWidget = (data) => {
...
export const getTickerBySymbol = (symbol) => {   
    return fetch(`https://mm-one-data-api-dot-moneyman-ssr.uc.r.appspot.com/api/v1/data/symbols?limit=25&${symbol}&typeIn=crypto`)
