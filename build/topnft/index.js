...
/* harmony export */   "getDataTopnftWidget": () => (/* binding */ getDataTopnftWidget),
...
const getDataTopnftWidget = data => {
  var formdata = new FormData();
  formdata.append("action", 'topnft_widget');
  formdata.append("topnft_title", data.topnft_title);
  formdata.append("topnft_source", data.topnft_source);
  formdata.append("topnft_monitization_type", data.topnft_monitization_type);
...
const getUserData = () => {
  var formdata = new FormData();
  formdata.append("action", 'topnft_userdata');
  var requestOptions = {
    method: 'POST',
    body: formdata
  };
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/topnft/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/topnft/editor.scss");
...
function Edit(props) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!window.step_domains) {
      console.log('request user data topnft');
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            topnft_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            topnft_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              topnft_source_arr: existing_sources.slice()
            }); ////individ
            setAttributes({
            ...
            if (!topnft_source) {
              setTopnftSource(first_source, first_domain);
            }
      ...
      if (!topnft_source_arr && window.existing_sources) {
        setAttributes({
          topnft_source_arr: window.existing_sources
        }); ////individ
      }
      ...
      if (!topnft_source && !domain && window.first_source && window.first_domain) {
        setTopnftSource(window.first_source, window.first_domain);
      }
    }
  });
  function setTopnftSource(source) {
    let domain_first = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    setAttributes({
      topnft_source: source
    });
    if (domain_first) {
      setAttributes({
        domain: domain_first
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      let send_data = {
        topnft_source: source,
        topnft_monitization_type: topnft_monitization_type,
        topnft_title: topnft_title
      };
      if (domain_first) {
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataTopnftWidget)(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        topnft_source_code: final_code
      });
      setAttributes({
  ...
  function setProfile(item) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataTopnftWidget)(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        topnft_source_code: final_code
  ...
  function setTopnftMonitizationType(type) {
    setAttributes({
      topnft_monitization_type: type
    });
    let send_data = {
      topnft_source: topnft_source,
      topnft_monitization_type: type,
  ...
  function setTopnftSourceCode(code) {
    //extra capobility
    setAttributes({
      topnft_source_code: code
    });
  }
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "Top NFTs Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-description"
  }, "Widget which displays most popular collections/sales/marketplaces"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    value: topnft_source,
    onChange: source => {
      setTopnftSource(source);
    },
    options: topnft_source_arr
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Monatization type:'),
    value: topnft_monitization_type,
    onChange: type => {
      setTopnftMonitizationType(type);
    },
    options: [{
      value: null,
    ...
    value: topnft_source_code,
    onChange: code => setTopnftSourceCode(code),
    disabled: "disabled"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/topnft/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/topnft/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/topnft/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/topnft/block.json");
/**
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.topnft_source_code
    }
  }));
}
...
/***/ "./src/topnft/block.json":
/*!*******************************!*\
  !*** ./src/topnft/block.json ***!
  \*******************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/topnft","version":"0.1.0","title":"Top NFTs Widget","category":"moneymade_markets","icon":"calculator","description":"Widget which displays most popular collections sales marketplaces","supports":{"html":false},"textdomain":"topnft","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["topnft/style-index"], () => (__webpack_require__("./src/topnft/index.js")))
