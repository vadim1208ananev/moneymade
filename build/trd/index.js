...
/* harmony export */   "getDataTrdWidget": () => (/* binding */ getDataTrdWidget),
...
const getDataTrdWidget = data => {
  var formdata = new FormData();
  formdata.append("action", 'trd_widget');
  formdata.append("trd_title", data.trd_title);
  formdata.append("trd_source", data.trd_source);
...
const getUserData = () => {
  var formdata = new FormData();
  formdata.append("action", 'trd_userdata');
  var requestOptions = {
    method: 'POST',
    body: formdata
  };
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/trd/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/trd/editor.scss");
...
function Edit(props) {
    ...
    if (!window.step_domains) {
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            trd_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            trd_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              trd_source_arr: existing_sources.slice()
            }); ////individ
            setAttributes({
            ...
            if (!trd_source) {
              setTrdSource(first_source, first_domain);
            }
      ...
      if (!trd_source_arr && window.existing_sources) {
        setAttributes({
          trd_source_arr: window.existing_sources
        }); ////individ
      }
      ...
      if (!trd_source && !domain && window.first_source && window.first_domain) {
        setTrdSource(window.first_source, window.first_domain);
      }
    }
  });
  function setTrdSource(source) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataTrdWidget)(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        trd_source_code: final_code
      });
      setAttributes({
  ...
  function setTrdSourceCode(code) {
    //extra capobility
    setAttributes({
      trd_source_code: code
    });
  }
  function setTitle(title) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataTrdWidget)(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        trd_source_code: final_code
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "The Revenue Driver Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-description"
  }, "The Revenue Driver is one of our most popular widgets. This Revenue Driver showcases our premium partners with necessary information and data to drive valuable clicks. Our Adtech AI will optimize what products are shown to your users in every widget, even on specific articles - all based on the highest RPMs."), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    value: trd_source_code,
    onChange: code => setTrdSourceCode(code),
    disabled: "disabled"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/trd/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/trd/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/trd/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/trd/block.json");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  attributes: {
    ...
    trd_source_code: {
      type: 'string',
      default: '<div id="horizontalOffers-49ea630b-84e5-4cf1-8341-56bda6555493" class="money-made-embed" data-name="The Revenue Driver" data-width="100%" data-height="0" data-embed-widget="horizontalOffers" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="horizontaloffers" style="display:block"></div>'
    },
    html_to_iframe: {
      type: 'string',
      default: '<html><head><meta charset="utf-8"><title>srcdoc</title><script defer src="https://markets.moneymade.io/embed/v2.min.js"></script></head><body><div id="horizontalOffers-49ea630b-84e5-4cf1-8341-56bda6555493" class="money-made-embed" data-name="The Revenue Driver" data-width="100%" data-height="0" data-embed-widget="horizontalOffers" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="horizontaloffers" style="display:block"></div></body></html>'
    }
  },
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.trd_source_code
    }
  }));
}
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/trd","version":"0.1.0","title":"The Revenue Driver Widget","category":"moneymade_monetization","icon":"calculator","description":"The Revenue Driver is one of our most popular widgets. This Revenue Driver showcases our premium partners with necessary information and data to drive valuable clicks. Our Adtech AI will optimize what products are shown to your users in every widget, even on specific articles - all based on the highest RPMs.","supports":{"html":false},"textdomain":"trd","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["trd/style-index"], () => (__webpack_require__("./src/trd/index.js")))
