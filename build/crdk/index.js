...
/* harmony export */   "getDataСrdkWidget": () => (/* binding */ getDataСrdkWidget),
...
const getDataСrdkWidget = data => {
  var formdata = new FormData();
  formdata.append("action", 'crdk_widget');
  formdata.append("crdk_title", data.crdk_title);
  formdata.append("crdk_source", data.crdk_source);
...
const getUserData = () => {
  var formdata = new FormData();
  formdata.append("action", 'crdk_userdata');
  var requestOptions = {
    method: 'POST',
    body: formdata
  };
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/crdk/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/crdk/editor.scss");
...
function Edit(props) {
    ...
    if (!window.step_domains) {
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            crdk_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            crdk_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              crdk_source_arr: existing_sources.slice()
            }); ////individ
            setAttributes({
            ...
            if (!crdk_source) {
              setСrdkSource(first_source, first_domain);
            }
      ...
      if (!crdk_source_arr && window.existing_sources) {
        setAttributes({
          crdk_source_arr: window.existing_sources
        }); ////individ
      }
      ...
      if (!crdk_source && !domain && window.first_source && window.first_domain) {
        setСrdkSource(window.first_source, window.first_domain);
      }
    }
  });
  function setСrdkSource(source) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__["getDataСrdkWidget"])(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        crdk_source_code: final_code
      });
      setAttributes({
  ...
  function setCrdkSourceCode(code) {
    //extra capobility
    setAttributes({
      crdk_source_code: code
    });
  }
  function setTitle(title) {
    ...
    let send_data = {
      crdk_title: title,
      crdk_source: crdk_source,
      profile: profile
    };
    (0,_api__WEBPACK_IMPORTED_MODULE_3__["getDataСrdkWidget"])(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        crdk_source_code: final_code
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "Compact Revenue Dark Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    value: crdk_source,
    onChange: source => {
      setСrdkSource(source);
    },
    options: crdk_source_arr
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
    ...
    value: crdk_source_code,
    onChange: code => setCrdkSourceCode(code),
    disabled: "disabled"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/crdk/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/crdk/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/crdk/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/crdk/block.json");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  attributes: {
    ...
    crdk_source_code: {
      type: 'string',
      default: '<div id="compact-revenue-dark-757747e7-7c7b-4df0-92ac-e09c00a0fa34" class="money-made-embed" data-name="Compact Revenue Dark" data-width="100%" data-height="0" data-embed-widget="compact-revenue-dark" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="compactRevenueDark" style="display:block"></div>'
    },
    html_to_iframe: {
      type: 'string',
      default: '<html><head><meta charset="utf-8"><title>srcdoc</title><script defer src="https://markets.moneymade.io/embed/v2.min.js"></script></head><body><div id="compact-revenue-dark-757747e7-7c7b-4df0-92ac-e09c00a0fa34" class="money-made-embed" data-name="Compact Revenue Dark" data-width="100%" data-height="0" data-embed-widget="compact-revenue-dark" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="compactRevenueDark" style="display:block"></div></body></html>'
    }
  },
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.crdk_source_code
    }
  }));
}
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/crdk","version":"0.1.0","title":"Compact Revenue Dark Widget","category":"moneymade_monetization","icon":"calculator","description":"The Revenue Driver is one of our most popular widgets. This Revenue Driver showcases our premium partners with necessary information and data to drive valuable clicks. Our Adtech AI will optimize what products are shown to your users in every widget, even on specific articles - all based on the highest RPMs.","supports":{"html":false},"textdomain":"crdk","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["crdk/style-index"], () => (__webpack_require__("./src/crdk/index.js")))
