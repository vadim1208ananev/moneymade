...
/* harmony export */   "getDataEditorialWidget": () => (/* binding */ getDataEditorialWidget),
...
const getDataEditorialWidget = data => {
  var formdata = new FormData();
  formdata.append("action", 'editorial_widget');
  formdata.append("editorial_title", data.editorial_title);
  formdata.append("editorial_source", data.editorial_source);
...
const getUserData = () => {
  var formdata = new FormData();
  formdata.append("action", 'editorial_userdata');
  var requestOptions = {
    method: 'POST',
    body: formdata
  };
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/editorial/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/editorial/editor.scss");
...
function Edit(props) {
  const {
    attributes: {
      ...
      editorial_source,
      auth_result,
      editorial_source_arr,
      editorial_source_code,
      html_to_iframe,
      editorial_title
    },
    setAttributes
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!window.step_domains) {
      console.log('request user data editorial');
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            editorial_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            editorial_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              editorial_source_arr: existing_sources.slice()
            }); ////individ
            setAttributes({
            ...
            if (!editorial_source) {
              setEditorialSource(first_source, first_domain);
            }
      ...
      if (!editorial_source_arr && window.existing_sources) {
        setAttributes({
          editorial_source_arr: window.existing_sources
        }); ////individ
      }
      ...
      if (!editorial_source && !domain && window.first_source && window.first_domain) {
        setEditorialSource(window.first_source, window.first_domain);
      }
    }
  });
  function setEditorialSource(source) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataEditorialWidget)(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        editorial_source_code: final_code
      });
      setAttributes({
  ...
  function setEditorialSourceCode(code) {
    //extra capobility
    setAttributes({
      editorial_source_code: code
    });
  }
  function setTitle(title) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataEditorialWidget)(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        editorial_source_code: final_code
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "Editorial Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-description"
  }, "This widget has a more native content look and feel."), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onChange: source => {
      setEditorialSource(source);
    },
    options: editorial_source_arr
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
    ...
    value: editorial_source_code,
    onChange: code => setEditorialSourceCode(code),
    disabled: "disabled"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/editorial/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/editorial/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/editorial/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/editorial/block.json");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  attributes: {
    ...
    editorial_source_code: {
      type: 'string',
      default: '<div id="editorial-e7170dc1-7b34-4716-9ec4-6fbf5dc9c3a2" class="money-made-embed" data-name="Editorial" data-width="100%" data-height="0" data-embed-widget="editorial" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="editorial" style="display:block"></div>'
    },
    html_to_iframe: {
      type: 'string',
      default: '<html><head><meta charset="utf-8"><title>srcdoc</title><script defer src="https://markets.moneymade.io/embed/v2.min.js"></script></head><body><div id="editorial-e7170dc1-7b34-4716-9ec4-6fbf5dc9c3a2" class="money-made-embed" data-name="Editorial" data-width="100%" data-height="0" data-embed-widget="editorial" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="editorial" style="display:block"></div></body></html>'
    }
  },
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.editorial_source_code
    }
  }));
}
...
/***/ "./src/editorial/block.json":
/*!**********************************!*\
  !*** ./src/editorial/block.json ***!
  \**********************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/editorial","version":"0.1.0","title":"Editorial Widget","category":"moneymade_monetization","icon":"calculator","description":"This widget has a more native content look and feel.","supports":{"html":false},"textdomain":"editorial","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["editorial/style-index"], () => (__webpack_require__("./src/editorial/index.js")))
