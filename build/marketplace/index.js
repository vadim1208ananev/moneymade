...
/* harmony export */   "getDataMarketplaceWidget": () => (/* binding */ getDataMarketplaceWidget),
...
const getDataMarketplaceWidget = data => {
  var formdata = new FormData();
  formdata.append("action", 'marketplace_widget');
  formdata.append("marketplace_source", data.marketplace_source);
...
const getUserData = () => {
  var formdata = new FormData();
  formdata.append("action", 'marketplace_userdata');
  var requestOptions = {
    method: 'POST',
    body: formdata
  };
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/marketplace/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/marketplace/editor.scss");
...
function Edit(props) {
  const {
    attributes: {
      ...
      marketplace_source,
      auth_result,
      marketplace_source_arr,
      marketplace_source_code,
      html_to_iframe,
      marketplace_title
    },
    setAttributes
    ...
    if (!window.step_domains) {
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            marketplace_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            marketplace_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              marketplace_source_arr: existing_sources.slice()
            }); ////individ
            setAttributes({
      ...
      if (!marketplace_source_arr && window.existing_sources) {
        setAttributes({
          marketplace_source_arr: window.existing_sources
        }); ////individ
      }
  ...
  function setMarketplaceSource(source) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataMarketplaceWidget)(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        marketplace_source_code: final_code
      });
      setAttributes({
  ...
  function setMarketplaceSourceCode(code) {
    //extra capobility
    setAttributes({
      marketplace_source_code: code
    });
  }
  ...
  function setProfile(item) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataMarketplaceWidget)(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        marketplace_source_code: final_code
  ...
  }, "Marketplace Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/marketplace/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/marketplace/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/marketplace/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/marketplace/block.json");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  attributes: {
    ...
    marketplace_source_code: {
      type: 'string',
      default: '<div id="marketplace-e7170dc1-7b34-4716-9ec4-6fbf5dc9c3a2" class="money-made-embed" data-name="Marketplace" data-width="100%" data-height="0" data-embed-widget="marketplace" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="marketplace" style="display:block"></div>'
    },
    html_to_iframe: {
      type: 'string',
      default: '<html><head><meta charset="utf-8"><title>srcdoc</title><script defer src="https://markets.moneymade.io/embed/v2.min.js"></script></head><body><div id="marketplace-e7170dc1-7b34-4716-9ec4-6fbf5dc9c3a2" class="money-made-embed" data-name="Marketplace" data-width="100%" data-height="0" data-embed-widget="marketplace" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="marketplace" style="display:block"></div></body></html>'
    }
  },
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.marketplace_source_code
    }
  }));
}
...
/***/ "./src/marketplace/block.json":
/*!************************************!*\
  !*** ./src/marketplace/block.json ***!
  \************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/marketplace","version":"0.1.0","title":"Marketplace Widget","category":"moneymade_monetization","icon":"calculator","description":"This widget has a more native content look and feel.","supports":{"html":false},"textdomain":"marketplace","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["marketplace/style-index"], () => (__webpack_require__("./src/marketplace/index.js")))
