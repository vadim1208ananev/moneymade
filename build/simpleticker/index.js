...
/* harmony export */   "getDataSimpleWidget": () => (/* binding */ getDataSimpleWidget),
...
const getDataSimpleWidget = data => {
  var formdata = new FormData();
  formdata.append("action", 'simple_widget');
  formdata.append("simple_ticker", data.simple_ticker);
  formdata.append("simple_source", data.simple_source);
  formdata.append("simple_monitization_type", data.simple_monitization_type);
  formdata.append("symbol_search", data.symbol_search);
...
const getUserData = () => {
  var formdata = new FormData();
  formdata.append("action", 'simple_userdata');
  var requestOptions = {
    method: 'POST',
    body: formdata
  };
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/simpleticker/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/simpleticker/editor.scss");
...
function Edit(props) {
    ...
    if (!window.step_domains) {
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            simple_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            simple_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              simple_source_arr: existing_sources.slice()
            }); ////
            setAttributes({
            ...
            if (!simple_source) {
              setSimpleSource(first_source, first_domain);
            }
      ...
      if (!simple_source_arr && window.existing_sources) {
        setAttributes({
          simple_source_arr: window.existing_sources
        }); ////individ		
      }
      ...
      if (!simple_source && !domain && window.first_source && window.first_domain) {
        setSimpleSource(window.first_source, window.first_domain);
      }
    }
  });
  function setSimpleSource(source) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      let send_data = {
        simple_source: source,
        simple_monitization_type: simple_monitization_type,
        simple_ticker: regSticker(simple_ticker),
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataSimpleWidget)(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        simple_source_code: final_code
      });
      setAttributes({
  ...
  function setProfile(item) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataSimpleWidget)(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        simple_source_code: final_code
  ...
  function setSimpleMonitizationType(type) {
    setAttributes({
      simple_monitization_type: type
    });
    let send_data = {
      simple_monitization_type: type,
      simple_source: simple_source,
  ...
  function setSimpleSourceCode(code) {
    //extra capobility
    setAttributes({
      simple_source_code: code
    });
  }
  ...
  function getTicker(ticker) {
    if (ticker.includes('abbr') && regSticker(ticker)) {
      setAttributes({
        simple_ticker: ticker
      });
      let send_data = {
        simple_monitization_type: simple_monitization_type,
        simple_source: simple_source,
        simple_ticker: regSticker(ticker),
        symbol_search: symbol_search,
        profile: profile
      };
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataSimpleWidget)(send_data).then(res => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "Simple Ticker Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-description"
  }, "A returns chart for one publicly traded ticker, asset class or asset sub-category."), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    value: simple_source,
    onChange: source => {
      setSimpleSource(source);
    },
    options: simple_source_arr
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Monatization type:'),
    value: simple_monitization_type,
    onChange: type => {
      setSimpleMonitizationType(type);
    },
    options: [{
      value: null,
    ...
    value: simple_source_code,
    onChange: code => setSimpleSourceCode(code),
    disabled: "disabled"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/simpleticker/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/simpleticker/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/simpleticker/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/simpleticker/block.json");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  attributes: {
    ...
    simple_source_code: {
      type: 'string',
      default: '<div id="ticker-simple-5eca8506-bad8-40a1-a764-82d15c20f8f6" class="money-made-embed" data-name="Simple Ticker" data-width="100%" data-height="0" data-embed-widget="ticker-simple" data-params="monetization=3" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="tickerSimple" style="display:block"></div>'
    },
    html_to_iframe: {
      type: 'string',
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.simple_source_code
    }
  });
}
...
/***/ "./src/simpleticker/block.json":
/*!*************************************!*\
  !*** ./src/simpleticker/block.json ***!
  \*************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/simpleticker","version":"0.1.0","title":"Simple Ticker Widget","category":"moneymade_markets","icon":"calculator","description":"A returns chart for one publicly traded ticker, asset class or asset sub-category.","supports":{"html":false},"textdomain":"simpleticker","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"simpleticker/index": 0,
/******/ 			"simpleticker/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["simpleticker/style-index"], () => (__webpack_require__("./src/simpleticker/index.js")))
