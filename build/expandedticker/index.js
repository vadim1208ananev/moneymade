...
/* harmony export */   "getDataExpandedTickerWidget": () => (/* binding */ getDataExpandedTickerWidget),
...
const getDataExpandedTickerWidget = data => {
  var formdata = new FormData();
  formdata.append("action", 'expandedticker_widget');
  formdata.append("expandedticker_ticker", data.expandedticker_ticker);
  formdata.append("expandedticker_source", data.expandedticker_source);
  formdata.append("expandedticker_monitization_type", data.expandedticker_monitization_type);
  formdata.append("expandedticker_comparasion_ticker", data.expandedticker_comparasion_ticker);
...
const getUserData = () => {
  var formdata = new FormData();
  formdata.append("action", 'expandedticker_userdata');
  var requestOptions = {
    method: 'POST',
    body: formdata
  };
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/expandedticker/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/expandedticker/editor.scss");
...
function Edit(props) {
  const {
    attributes: {
      ...
      profile_arr,
      symbol_search,
      expandedticker_source,
      auth_result,
      expandedticker_source_arr,
      expandedticker_monitization_type,
      expandedticker_source_code,
      expandedticker_ticker,
      expandedticker_comparasion_ticker,
      html_to_iframe
    },
    setAttributes
  } = props;
    ...
    if (!window.step_domains) {
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            expandedticker_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            expandedticker_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              expandedticker_source_arr: existing_sources.slice()
            }); ////individ
            setAttributes({
            ...
            if (!expandedticker_source) {
              setExpandedTickerSource(first_source, first_domain);
            }
      ...
      if (!expandedticker_source_arr && window.existing_sources) {
        setAttributes({
          expandedticker_source_arr: window.existing_sources
        }); ////individ
      }
      ...
      if (!expandedticker_source && !domain && window.first_source && window.first_domain) {
        setExpandedTickerSource(window.first_source, window.first_domain);
      }
    }
  });
  function setExpandedTickerSource(source) {
    let domain_first = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    setAttributes({
      expandedticker_source: source
    });
    if (domain_first) {
      setAttributes({
        domain: domain_first
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      let send_data = {
        expandedticker_source: source,
        expandedticker_monitization_type: expandedticker_monitization_type,
        expandedticker_ticker: regSticker(expandedticker_ticker),
        expandedticker_comparasion_ticker: regSticker(expandedticker_comparasion_ticker),
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataExpandedTickerWidget)(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        expandedticker_source_code: final_code
      });
      setAttributes({
  ...
  function setExpandedTickerMonitizationType(type) {
    setAttributes({
      expandedticker_monitization_type: type
    });
    let send_data = {
      expandedticker_monitization_type: type,
      expandedticker_source: expandedticker_source,
      expandedticker_ticker: regSticker(expandedticker_ticker),
      expandedticker_comparasion_ticker: regSticker(expandedticker_comparasion_ticker),
      symbol_search: symbol_search,
      profile: profile
    };
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataExpandedTickerWidget)(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        expandedticker_source_code: final_code
  ...
  function setExpandedTickerSourceCode(code) {
    //extra capobility
    setAttributes({
      expandedticker_source_code: code
    });
  }
  ...
  function setTicker(ticker) {
    if (ticker.includes('abbr') && regSticker(ticker)) {
      setAttributes({
        expandedticker_ticker: ticker
      });
      let send_data = {
        expandedticker_monitization_type: expandedticker_monitization_type,
        expandedticker_source: expandedticker_source,
        expandedticker_ticker: regSticker(ticker),
        expandedticker_comparasion_ticker: regSticker(expandedticker_comparasion_ticker),
        symbol_search: symbol_search,
        profile: profile
      };
  ...
  function setComparasionTicker(ticker) {
    if (ticker.includes('abbr') && regSticker(ticker)) {
      setAttributes({
        expandedticker_comparasion_ticker: ticker
      });
      let send_data = {
        expandedticker_monitization_type: expandedticker_monitization_type,
        expandedticker_source: expandedticker_source,
        expandedticker_ticker: regSticker(expandedticker_ticker),
        expandedticker_comparasion_ticker: regSticker(ticker),
        symbol_search: symbol_search,
        profile: profile
      };
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataExpandedTickerWidget)(send_data).then(res => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "Expanded Ticker Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    value: expandedticker_source,
    onChange: source => {
      setExpandedTickerSource(source);
    },
    options: expandedticker_source_arr
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Monatization type:'),
    value: expandedticker_monitization_type,
    onChange: type => {
      setExpandedTickerMonitizationType(type);
    },
    options: [{
      value: null,
    ...
    autocompleters: autoConfigs,
    value: expandedticker_comparasion_ticker,
    ...
    value: expandedticker_source_code,
    onChange: code => setExpandedTickerSourceCode(code),
    disabled: "disabled"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/expandedticker/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/expandedticker/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/expandedticker/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/expandedticker/block.json");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  attributes: {
    ...
    expandedticker_source_code: {
      type: 'string',
      default: '<div id="ticker-graph-c3516d4b-1a15-4bca-a1da-f7ecd4a62667" class="money-made-embed" data-name="Expanded Ticker" data-width="100%" data-height="0" data-embed-widget="ticker-graph" data-params="monetization=3" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="tickerGraph" style="display:block"></div>'
    },
    html_to_iframe: {
      type: 'string',
      default: '<html><head><meta charset="utf-8"><title>srcdoc</title><script defer src="https://markets.moneymade.io/embed/v2.min.js"></script></head><body><div id="ticker-graph-c3516d4b-1a15-4bca-a1da-f7ecd4a62667" class="money-made-embed" data-name="Expanded Ticker" data-width="100%" data-height="0" data-embed-widget="ticker-graph" data-params="monetization=3" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="tickerGraph" style="display:block"></div></body></html>'
    },
    expandedticker_ticker: {
      type: 'string',
      default: ''
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.expandedticker_source_code
    }
  });
}
...
/***/ "./src/expandedticker/editor.scss":
/*!****************************************!*\
  !*** ./src/expandedticker/editor.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/expandedticker/block.json":
/*!***************************************!*\
  !*** ./src/expandedticker/block.json ***!
  \***************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/expandedticker","version":"0.1.0","title":"Expanded Ticker Widget","category":"moneymade_markets","icon":"calculator","description":"A returns chart for one publicly traded ticker, asset class or asset sub-category, plus S&P 500 comparison and additional performance metrics","supports":{"html":false},"textdomain":"expandedticker","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"expandedticker/index": 0,
/******/ 			"expandedticker/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["expandedticker/style-index"], () => (__webpack_require__("./src/expandedticker/index.js")))
