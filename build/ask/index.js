...
/* harmony export */   "getDataAskWidget": () => (/* binding */ getDataAskWidget),
...
const getDataAskWidget = data => {
  var formdata = new FormData();
  formdata.append("action", 'ask_widget');
  formdata.append("ask_source", data.ask_source);
...
const getUserData = () => {
  var formdata = new FormData();
  formdata.append("action", 'ask_userdata');
  var requestOptions = {
    method: 'POST',
    body: formdata
  };
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/ask/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/ask/editor.scss");
...
function Edit(props) {
    ...
    if (!window.step_domains) {
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            ask_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            ask_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              ask_source_arr: existing_sources.slice()
            }); ////individ
            setAttributes({
            ...
            if (!ask_source) {
              setAskSource(first_source, first_domain);
            }
      ...
      if (!ask_source_arr && window.existing_sources) {
        setAttributes({
          ask_source_arr: window.existing_sources
        }); ////individ
      }
      ...
      if (!ask_source && !domain && window.first_source && window.first_domain) {
        setAskSource(window.first_source, window.first_domain);
      }
    }
  });
  function setAskSource(source) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataAskWidget)(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        ask_source_code: final_code
      });
      setAttributes({
  ...
  function setProfile(item) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataAskWidget)(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        ask_source_code: final_code
  ...
  function setAskSourceCode(code) {
    //extra capobility
    setAttributes({
      ask_source_code: code
    });
  }
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "Ask An Expert Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    value: ask_source_code,
    onChange: code => setAskSourceCode(code),
    disabled: "disabled"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/ask/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/ask/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/ask/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/ask/block.json");
/**
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.ask_source_code
    }
  }));
}
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/ask","version":"0.1.0","title":"Ask An Expert Widget","category":"moneymade_markets","icon":"calculator","description":"Here you can find a ready to go code to use the widget inside a modal","supports":{"html":false},"textdomain":"ask","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["ask/style-index"], () => (__webpack_require__("./src/ask/index.js")))
