...
/* harmony export */   "getDataPerformanceWidget": () => (/* binding */ getDataPerformanceWidget),
...
const getDataPerformanceWidget = data => {
  var formdata = new FormData();
  formdata.append("action", 'performance_widget');
  formdata.append("performance_title", data.performance_title);
  formdata.append("performance_source", data.performance_source);
...
const getUserData = () => {
  var formdata = new FormData();
  formdata.append("action", 'performance_userdata');
  var requestOptions = {
    method: 'POST',
    body: formdata
  };
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/performance/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/performance/editor.scss");
...
function Edit(props) {
    ...
    if (!window.step_domains) {
      ...
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            performance_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            performance_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              performance_source_arr: existing_sources.slice()
            }); ////individ
            setAttributes({
      ...
      if (!performance_source_arr && window.existing_sources) {
        setAttributes({
          performance_source_arr: window.existing_sources
        }); ////individ
      }
  ...
  function setPerformanceSource(source) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataPerformanceWidget)(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        performance_source_code: final_code
      });
      setAttributes({
  ...
  function setPerformanceSourceCode(code) {
    //extra capobility
    setAttributes({
      performance_source_code: code
    });
  }
  function setTitle(title) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataPerformanceWidget)(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        performance_source_code: final_code
  ...
  }, "Performance Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/performance/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/performance/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/performance/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/performance/block.json");
/**
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.performance_source_code
    }
  }));
}
...
/***/ "./src/performance/block.json":
/*!************************************!*\
  !*** ./src/performance/block.json ***!
  \************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/performance","version":"0.1.0","title":"Performance Widget","category":"moneymade_monetization","icon":"calculator","description":"","supports":{"html":false},"textdomain":"performance","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["performance/style-index"], () => (__webpack_require__("./src/performance/index.js")))
