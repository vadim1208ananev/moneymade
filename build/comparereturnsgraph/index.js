...
/***/ "./src/comparereturnsgraph/api.js":
/*!****************************************!*\
  !*** ./src/comparereturnsgraph/api.js ***!
  \****************************************/
...
/* harmony export */   "getDataComparereturnsgraphWidget": () => (/* binding */ getDataComparereturnsgraphWidget),
...
const getDataComparereturnsgraphWidget = data => {
  var formdata = new FormData();
  formdata.append("action", 'comparereturnsgraph_widget');
  formdata.append("comparereturnsgraph_title", data.comparereturnsgraph_title);
  formdata.append("comparereturnsgraph_source", data.comparereturnsgraph_source);
  formdata.append("comparereturnsgraph_monitization_type", data.comparereturnsgraph_monitization_type);
  formdata.append("comparereturnsgraph_ticker1", data.comparereturnsgraph_ticker1);
  formdata.append("comparereturnsgraph_ticker2", data.comparereturnsgraph_ticker2);
  formdata.append("comparereturnsgraph_ticker3", data.comparereturnsgraph_ticker3);
  formdata.append("comparereturnsgraph_ticker4", data.comparereturnsgraph_ticker4);
...
const getUserData = () => {
  var formdata = new FormData();
  formdata.append("action", 'comparereturnsgraph_userdata');
  var requestOptions = {
    method: 'POST',
    body: formdata
  };
...
/***/ "./src/comparereturnsgraph/edit.js":
/*!*****************************************!*\
  !*** ./src/comparereturnsgraph/edit.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/comparereturnsgraph/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/comparereturnsgraph/editor.scss");
...
function Edit(props) {
    ...
    if (!window.step_domains) {
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            comparereturnsgraph_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            comparereturnsgraph_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              comparereturnsgraph_source_arr: existing_sources.slice()
            }); ////individ
            setAttributes({
      ...
      if (!comparereturnsgraph_source_arr && window.existing_sources) {
        setAttributes({
          comparereturnsgraph_source_arr: window.existing_sources
        }); ////individ
      }
  ...
  function setComparereturnsgraphSource(source) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataComparereturnsgraphWidget)(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        comparereturnsgraph_source_code: final_code
      });
      setAttributes({
  ...
  function setComparereturnsgraphMonitizationType(type) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataComparereturnsgraphWidget)(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        comparereturnsgraph_source_code: final_code
  ...
  function setComparereturnsgraphSourceCode(code) {
    //extra capobility
    setAttributes({
      comparereturnsgraph_source_code: code
    });
  }
  ...
  function setTicker1(ticker) {
    if (ticker.includes('abbr') && regSticker(ticker)) {
      setAttributes({
        comparereturnsgraph_ticker1: ticker
      });
      let send_data = {
        comparereturnsgraph_title: comparereturnsgraph_title,
        comparereturnsgraph_source: comparereturnsgraph_source,
  ...
  function setTicker2(ticker) {
    if (ticker.includes('abbr') && regSticker(ticker)) {
      setAttributes({
        comparereturnsgraph_ticker2: ticker
      });
      let send_data = {
        comparereturnsgraph_title: comparereturnsgraph_title,
        comparereturnsgraph_source: comparereturnsgraph_source,
  ...
  function setTicker3(ticker) {
    if (ticker.includes('abbr') && regSticker(ticker)) {
      setAttributes({
        comparereturnsgraph_ticker3: ticker
      });
      let send_data = {
        comparereturnsgraph_title: comparereturnsgraph_title,
        comparereturnsgraph_source: comparereturnsgraph_source,
  ...
  function setTicker4(ticker) {
    if (ticker.includes('abbr') && regSticker(ticker)) {
      setAttributes({
        comparereturnsgraph_ticker4: ticker
      });
      let send_data = {
        comparereturnsgraph_title: comparereturnsgraph_title,
        comparereturnsgraph_source: comparereturnsgraph_source,
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "Compare Returns Graph Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-description"
  }, "A returns chart for one or four publicly traded ticker, asset class or asset sub-category"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onChange: source => {
      setComparereturnsgraphSource(source);
    },
    ...
    onChange: type => {
      setComparereturnsgraphMonitizationType(type);
    },
    options: [{
      value: null,
    ...
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(`Click ${autoConfigs[0].triggerPrefix} to find Ticker4`)
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    onClick: () => delTicker4(),
    variant: "secondary"
  }, "Delete ticker4")))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
...
/***/ "./src/comparereturnsgraph/index.js":
/*!******************************************!*\
  !*** ./src/comparereturnsgraph/index.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/comparereturnsgraph/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/comparereturnsgraph/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/comparereturnsgraph/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/comparereturnsgraph/block.json");
/**
...
/***/ "./src/comparereturnsgraph/save.js":
/*!*****************************************!*\
  !*** ./src/comparereturnsgraph/save.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.comparereturnsgraph_source_code
    }
  }));
}
...
/***/ "./src/comparereturnsgraph/editor.scss":
/*!*********************************************!*\
  !*** ./src/comparereturnsgraph/editor.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/comparereturnsgraph/style.scss":
/*!********************************************!*\
  !*** ./src/comparereturnsgraph/style.scss ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/comparereturnsgraph/block.json":
/*!********************************************!*\
  !*** ./src/comparereturnsgraph/block.json ***!
  \********************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/comparereturnsgraph","version":"0.1.0","title":"Compare Returns Graph Widget","category":"moneymade_markets","icon":"calculator","description":"A returns chart for one or four publicly traded ticker, asset class or asset sub-category","supports":{"html":false},"textdomain":"comparereturnsgraph","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"comparereturnsgraph/index": 0,
/******/ 			"comparereturnsgraph/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["comparereturnsgraph/style-index"], () => (__webpack_require__("./src/comparereturnsgraph/index.js")))
