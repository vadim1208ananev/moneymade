...
/* harmony export */   "getDataCryptopageWidget": () => (/* binding */ getDataCryptopageWidget),
...
const getDataCryptopageWidget = data => {
  var formdata = new FormData();
  formdata.append("action", 'cryptopage_widget');
  formdata.append("cryptopage_description", data.cryptopage_description);
  formdata.append("cryptopage_source", data.cryptopage_source);
  formdata.append("cryptopage_monitization_type", data.cryptopage_monitization_type);
  formdata.append("cryptopage_ticker", data.cryptopage_ticker);
...
const getUserData = () => {
  var formdata = new FormData();
  formdata.append("action", 'cryptopage_userdata');
  var requestOptions = {
    method: 'POST',
    body: formdata
  };
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/cryptopage/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/cryptopage/editor.scss");
...
function Edit(props) {
  const {
    attributes: {
      ...
      cryptopage_source,
      auth_result,
      cryptopage_source_arr,
      cryptopage_monitization_type,
      cryptopage_source_code,
      cryptopage_ticker,
      html_to_iframe,
    ...
    if (!window.step_domains) {
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            cryptopage_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            cryptopage_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              cryptopage_source_arr: existing_sources.slice()
            }); ////individ
            setAttributes({
      ...
      if (!cryptopage_source_arr && window.existing_sources) {
        setAttributes({
          cryptopage_source_arr: window.existing_sources
        }); ////individ
      }
  ...
  function setCryptopageSource(source) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataCryptopageWidget)(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        cryptopage_source_code: final_code
      });
      setAttributes({
  ...
  function setProfile(item) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataCryptopageWidget)(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        cryptopage_source_code: final_code
  ...
  function setCryptopageSourceCode(code) {
    //extra capobility
    setAttributes({
      cryptopage_source_code: code
    });
  }
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "Crypto page Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-description"
  }, "Page with the overall statistic for crypto coin"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onChange: type => {
      setCryptopageMonitizationType(type);
    },
    options: [{
      value: null,
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/cryptopage/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/cryptopage/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/cryptopage/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/cryptopage/block.json");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  attributes: {
    ...
    cryptopage_source_code: {
      type: 'string',
      default: '<div id="full-crypto-a08ccc53-d52a-403b-9f00-f37b9373d3bf" class="money-made-embed" data-name="Crypto page" data-width="100%" data-height="0" data-embed-widget="full-crypto" data-params="monetization=3" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="fullCrypto" style="display:block"></div>'
    },
    html_to_iframe: {
      type: 'string',
      default: '<html><head><meta charset="utf-8"><title>srcdoc</title><script defer src="https://markets.moneymade.io/embed/v2.min.js"></script></head><body><div id="full-crypto-a08ccc53-d52a-403b-9f00-f37b9373d3bf" class="money-made-embed" data-name="Crypto page" data-width="100%" data-height="0" data-embed-widget="full-crypto" data-params="monetization=3" data-utm-medium="REPLACE_WITH_PAGE_SLUG" data-utm-source="REPLACE_WITH_SOURCE" data-utm-campaign="fullCrypto" style="display:block"></div></body></html>'
    },
    cryptopage_ticker: {
      type: 'string',
      default: ''
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.cryptopage_source_code
    }
  }));
}
...
/***/ "./src/cryptopage/block.json":
/*!***********************************!*\
  !*** ./src/cryptopage/block.json ***!
  \***********************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/cryptopage","version":"0.1.0","title":"Crypto page Widget","category":"moneymade_markets","icon":"calculator","description":"Page with the overall statistic for US stocks/ETFs","supports":{"html":false},"textdomain":"cryptopage","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["cryptopage/style-index"], () => (__webpack_require__("./src/cryptopage/index.js")))
