...
/* harmony export */   "getDataIndustryWidget": () => (/* binding */ getDataIndustryWidget),
...
const getDataIndustryWidget = data => {
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/industry/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/industry/editor.scss");
...
function Edit(props) {
    ...
    if (!window.step_domains) {
      ...
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            industry_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            industry_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              industry_source_arr: existing_sources.slice()
            }); ////individ
            setAttributes({
      ...
      if (!industry_source_arr && window.existing_sources) {
        setAttributes({
          industry_source_arr: window.existing_sources
        }); ////individ
      }
  ...
  function setIndustrySource(source) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataIndustryWidget)(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        industry_source_code: final_code
      });
      setAttributes({
  ...
  function setProfile(item) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getDataIndustryWidget)(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        industry_source_code: final_code
  ...
  function setIndustrySourceCode(code) {
    //extra capobility
    setAttributes({
      industry_source_code: code
    });
  }
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "Industry specific Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-description"
  }, "Widget which allow to show industry specific platforms"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Industry:'),
    value: industry,
    onChange: ind => {
      setIndustry(ind);
    },
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/industry/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/industry/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/industry/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/industry/block.json");
/**
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.industry_source_code
    }
  }));
}
...
/***/ "./src/industry/block.json":
/*!*********************************!*\
  !*** ./src/industry/block.json ***!
  \*********************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/industry","version":"0.1.0","title":"Industry specific Widget","category":"moneymade_monetization","icon":"calculator","description":"Widget which allow to show industry specific platforms","supports":{"html":false},"textdomain":"industry","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["industry/style-index"], () => (__webpack_require__("./src/industry/index.js")))
