...
/* harmony export */   "getDataСrdrWidget": () => (/* binding */ getDataСrdrWidget),
...
const getDataСrdrWidget = data => {
  var formdata = new FormData();
  formdata.append("action", 'crdr_widget');
  formdata.append("crdr_title", data.crdr_title);
  formdata.append("crdr_source", data.crdr_source);
...
const getUserData = () => {
  var formdata = new FormData();
  formdata.append("action", 'crdr_userdata');
  var requestOptions = {
    method: 'POST',
    body: formdata
  };
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/crdr/api.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/crdr/editor.scss");
...
function Edit(props) {
    ...
    if (!window.step_domains) {
      (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserData)().then(res => {
        if (!res.status || !res.user_data || !res.prepare_data) {
          ...
          setAttributes({
            crdr_source_arr: empty_sources.slice()
          }); //individ
          setAttributes({
            crdr_source: ''
          }); //individ					
        ...
        (0,_api__WEBPACK_IMPORTED_MODULE_3__.getToken)(raw).then(res => {
          ...
          (0,_api__WEBPACK_IMPORTED_MODULE_3__.getUserDomains)(accessToken).then(res => {
            ...
            setAttributes({
              crdr_source_arr: existing_sources.slice()
            }); ////individ
            setAttributes({
            ...
            if (!crdr_source) {
              setСrdrSource(first_source, first_domain);
            }
      ...
      if (!crdr_source_arr && window.existing_sources) {
        setAttributes({
          crdr_source_arr: window.existing_sources
        }); ////individ
      }
      ...
      if (!crdr_source && !domain && window.first_source && window.first_domain) {
        setСrdrSource(window.first_source, window.first_domain);
      }
    }
  });
  function setСrdrSource(source) {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_3__.getProfiles)(domain_first).then(res => {
      ...
      return (0,_api__WEBPACK_IMPORTED_MODULE_3__["getDataСrdrWidget"])(send_data);
    }).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        crdr_source_code: final_code
      });
      setAttributes({
  ...
  function setСrdrSourceCode(code) {
    //extra capobility
    setAttributes({
      crdr_source_code: code
    });
  }
  function setTitle(title) {
    ...
    let send_data = {
      crdr_title: title,
      crdr_source: crdr_source,
      profile: profile
    };
    (0,_api__WEBPACK_IMPORTED_MODULE_3__["getDataСrdrWidget"])(send_data).then(res => {
      let final_code = res.final_code;
      let html_to_iframe = res.html_to_iframe;
      setAttributes({
        crdr_source_code: final_code
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "Compact Revenue Driver Widget"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    value: crdr_source,
    onChange: source => {
      setСrdrSource(source);
    },
    options: crdr_source_arr
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
    ...
    value: crdr_source_code,
    onChange: code => setСrdrSourceCode(code),
    disabled: "disabled"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "block-widget-body-elem"
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/crdr/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/crdr/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/crdr/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/crdr/block.json");
/**
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    dangerouslySetInnerHTML: {
      __html: attributes.crdr_source_code
    }
  }));
}
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"moneymade/crdr","version":"0.1.0","title":"Compact Revenue Driver Widget","category":"moneymade_monetization","icon":"calculator","description":"The Revenue Driver is one of our most popular widgets. This Revenue Driver showcases our premium partners with necessary information and data to drive valuable clicks. Our Adtech AI will optimize what products are shown to your users in every widget, even on specific articles - all based on the highest RPMs.","supports":{"html":false},"textdomain":"crdr","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["crdr/style-index"], () => (__webpack_require__("./src/crdr/index.js")))
